#ifndef __CARAVANA_H_
#define __CARAVANA_H_
#include "Tren.h"
#ifndef NULL
#define NULL      0
#endif
...
struct NodoCaravana {
    ...
    NodoCaravana* sgte; // puntero al siguiente
};

/* Tipo de Puntero a los Nodos de la Lista, el cual se usa para recorrer
   la Lista y acceder a sus Datos. */
typedef NodoCaravana* PtrNodoCaravana;


/* Tipo de Estructura de la Lista */
struct Caravana{
    PtrNodoCaravana primero;      // puntero al primer nodo de la lista
};
...
/*
  ...
  lista : lista sobre la cual se invoca la primitiva.
*/
void reordenar(Caravana &caravana);
